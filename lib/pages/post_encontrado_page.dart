...
class PostEncontradoPage extends StatefulWidget {
  const PostEncontradoPage({super.key, required this.postid});
  final String postid;
  @override
  State<PostEncontradoPage> createState() => _PostEncontradoPageState();
}

class _PostEncontradoPageState extends State<PostEncontradoPage> {
  @override
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        CarouselExample(jsn: jsn["mascotas"], tipo: "e"),
        Column(
