...
class CrearPostAdopcionPage extends StatefulWidget {
  const CrearPostAdopcionPage({super.key});

  @override
  State<CrearPostAdopcionPage> createState() => _CrearPostAdopcionPageState();
}

class _CrearPostAdopcionPageState extends State<CrearPostAdopcionPage> {
  List<Map> datos = [];
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: DefaultTabController(
          ...
          child: Scaffold(
              appBar: AppBar(
                title: const Text("Dar en adopcion"),
              ),
              body: MyTabs())),
    );
  }
...
class Tab_5 extends StatelessWidget {
  ...
  Future<void> crearPost(Map info, List masco, BuildContext ctx) async {
    ...
    var respuesta = await http.post(Uri.parse(ADOPCION_ADD),
              ...
              Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text("Requisitos para la adopcion:"),
                  ),
                  SizedBox(
                    height: 150,
                    child: TextFormField(
