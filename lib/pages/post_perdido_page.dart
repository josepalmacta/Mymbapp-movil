...
class PostPerdidoPage extends StatefulWidget {
  const PostPerdidoPage({super.key, required this.postid});
  final String postid;
  @override
  State<PostPerdidoPage> createState() => _PostPerdidoPageState();
}

class _PostPerdidoPageState extends State<PostPerdidoPage> {
  @override
