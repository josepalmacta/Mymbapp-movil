...
class PostsEncontradosPage extends StatefulWidget {
  const PostsEncontradosPage({super.key});

  @override
  State<PostsEncontradosPage> createState() => _PostsEncontradosPageState();
}

class _PostsEncontradosPageState extends State<PostsEncontradosPage> {
  String? selEspecie = "-1";
  ...
  Future<void> getReq() async {
    ...
    var result = await http.post(Uri.parse(ENCONTRADOS_LIST), body: parametros);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Mascotas Encontradas"),
      ),
