...
class PostsAdopcionPage extends StatefulWidget {
  const PostsAdopcionPage({super.key});

  @override
  State<PostsAdopcionPage> createState() => _PostsAdopcionPageState();
}

class _PostsAdopcionPageState extends State<PostsAdopcionPage> {
  String? selEspecie = "-1";
  ...
  Future<void> getReq() async {
    ...
    var result = await http.post(Uri.parse(ADOPCION_LIST), body: parametros);
